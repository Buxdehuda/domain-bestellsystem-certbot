...
curl -X POST -H "Content-Type: text/xml" \
    -H 'SOAPAction: nameserverRRCreate' \
...
'<soapenv:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns="http://soap.domain-bestellsystem.de/soap/1.1/">
   <soapenv:Header/>
   <soapenv:Body>
      <ns:nameserverRRCreate soapenv:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
         <nameserverRRCreateRequest xsi:type="ns:NameserverRRCreateRequestObject">
            <soaOrigin xsi:type="xsd:string">'"$DOMAIN"'</soaOrigin>
            <rr xsi:type="ns:ArrayOfNameserverrrelement">
               <item xsi:type="ns:NameserverRRElement">
         ...
         </nameserverRRCreateRequest>
      </ns:nameserverRRCreate>
   </soapenv:Body>
</soapenv:Envelope>' \
